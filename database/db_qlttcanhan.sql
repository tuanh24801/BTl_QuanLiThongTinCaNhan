...
(79, 'Thu Phương Nguyễn', '', '0000-00-00', '', 'ThuPhuong@gmail.com', 1, ''),
(80, 'Hoàng Bảo', '', '0000-00-00', '', 'hoanbao@gmail.com', 0, ''),
(81, 'Nguyễn Đông', '', '0000-00-00', '', 'NguyenDong@gmail.com', 1, ''),
(82, 'Hải Long', '', '0000-00-00', '', 'mephimhay97@gmail.com', 0, '');
...
(101, 'ss', 82, '2021-11-05 00:50:03', 'bac');
...
(79, 'user3', '123', '2021-11-04 23:40:56', 'ThuPhuong@gmail.com', '', 1, 0, 'Thu Phương Nguyễn', 1, 79),
(80, 'User4', '123', '2021-11-04 23:49:37', 'hoanbao@gmail.com', '', 1, 0, 'Hoàng Bảo', 1, 80),
(81, 'user8', '123', '2021-11-05 00:28:24', 'NguyenDong@gmail.com', '', 1, 0, 'Nguyễn Đông', 1, 81),
(82, 'hailongnguyen', '$2y$10$TLoriwfT6.RS39ZDyMxKhuYSuVoNf5AlJyXJo2vxeycnOlqivG16C', '2021-11-05 00:31:36', 'mephimhay97@gmail.com', '1aca1ade65990f4ddb9482d9e2011b7a', 1, 0, 'Hải Long', 0, 82);
...
--
ALTER TABLE `tb_banbe`
  MODIFY `id_banbe` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `tb_ketban`
--
ALTER TABLE `tb_ketban`
  MODIFY `id_loimoi` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `tb_lichhen`
--
ALTER TABLE `tb_lichhen`
  MODIFY `id_lichhen` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tb_nhiemvu`
--
ALTER TABLE `tb_nhiemvu`
  MODIFY `id_nhiemvu` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
...
--
ALTER TABLE `tb_taikhoan`
  MODIFY `id_taikhoan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
...
--
ALTER TABLE `tb_tinnhan`
  MODIFY `id_tinnhan` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=428;
...
--
ALTER TABLE `tb_trangthai`
  MODIFY `id_trangthai` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
