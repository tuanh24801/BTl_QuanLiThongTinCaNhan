        ...
        <div class="col-lg-12 col-xl-11">
            ...
            <div class="card-body p-md-5">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                    <!-- <p class="text-center mb mx-1 mx-md-4 mt-4"><i class="fal fa-id-card fw-bold"></i> Quản lí thông tin cá nhân</p> -->
                    ...
                    ?>
                    <form class="mx-1 mx-md-4" action = "xulydangnhap.php" method="post">
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                        <button type="submit" class="btn btn-primary btn-lg" name="sbmitdangnhap">Đăng nhập</button>
                    </div>
                    </form>
                </div>
